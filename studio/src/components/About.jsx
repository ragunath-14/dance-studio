      ...
      <div className="container">
        ...
        <div className="vision-grid highlight-section">
          ...
          >
            ...
            <p className="about-text">
              At KJ Dance Academy, we envision a world where dance is a universal language that connects people, transcends boundaries, and empowers individuals to express their authentic selves.
            </p>
            <p className="about-text">
