      ...
      <div className="container">
        <div className="why-choose-grid">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} className="why-text">
            <h2 className="why-choose-title">Why Choose <span>KJ?</span></h2>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} className="why-image">
            <img src="https://images.unsplash.com/photo-1546519638-68e109498ffc?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60" alt="Why KJ" />
          </motion.div>
        </div>
      </div>
    </section>
